...
class Router(object):
    ...
    def match(self, environ):
        ...
        #raise HTTPError(404, "yury: VERB : " + verb + "; path: " + path + "; self.static: " + str(self.static))
        ...
        methods = [verb]
        #raise HTTPError(404, "yury: methods" + str(methods))

        for method in methods:
            if method in self.static and path in self.static[method]:
                #raise HTTPError(404, "yury: methods 1" + str(methods))
                target, getargs = self.static[method][path]
                return target, getargs(path) if getargs else {}
            elif method in self.dyna_regexes:
                #raise HTTPError(402, "yury: methods" + str(methods))
        ...
        raise HTTPError(404, "Not found333: " + repr(path))
...
class Bottle(object):
    ...
    def _handle(self, environ):
        ...
        try:
            ...
            ##log('yury : ' + str(stacktrace)) : i will dump the whoel stack trace ::
            return HTTPError(500, str(stacktrace), _e(), stacktrace)
